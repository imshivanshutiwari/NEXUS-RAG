...
def sample_docs():
    return [
        ...
        {
            "doc_id": "doc2",
            "content": "pgvector enables ANN search inside PostgreSQL using HNSW indexing.",
            "source": "test",
        },
        {
            "doc_id": "doc3",
        ...
        {
            "doc_id": "doc4",
            "content": "ColBERT uses late interaction for efficient reranking.",
            "source": "test",
        },
        {
            "doc_id": "doc5",
            "content": "LangGraph builds stateful multi-agent pipelines as graphs.",
            "source": "test",
        },
    ]
